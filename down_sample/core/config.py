...
from down_sample.core.io import cache_url, pathmgr
...
_C.RESNET.SELFKD = False
# Number of groups to use (1 -> ResNet; > 1 -> ResNeXt)
_C.RESNET.NUM_GROUPS = 1
_C.RESNET.MASK_RATIO = 0.5
...
# return feature or not
_C.ANYNET.RETURN_FEATURE = False
...
_C.ANYNET.DROPBLOCK_ON = False

_C.ANYNET.DROPBLOCK_MAXDROP = 0.1

_C.ANYNET.DROPBLOCK_STEPS = 1000

_C.ANYNET.DROPBLOCK_BLOCKSIZE = 7
...
_C.REGNET.RETURN_FEATURE = False
...
_C.TRAIN.PRE_MODEL_LIST = []
_C.TRAIN.MERGE_MODE = 3

_C.TRAIN.UPSAMPLE_WCONV = False

_C.TRAIN.PRECISE_BN = False

# Upsamle bn mode
_C.TRAIN.BN_MODE = 4


_C.TRAIN.LOAD_CONV = True
# do kaiming normal refine after upsample
_C.TRAIN.NORMED_UPSAMPLE = False
...
_C.TRAIN.QUEUE_SIZE = 100
_C.TRAIN.START_BAKE_EPOCH = 10
_C.TRAIN.USE_NEG_TARGET = False
# --------------------------------- Testing options ---------------------------------- #
_C.TEST = CfgNode()
