...
if __name__ == '__main__':
    ...
    checkpoint_path = os.path.join('checkpoint_'+args.dataset, args.net, '4GPU', 'kd', str(args.b), str(args.lr), settings.TIME_NOW)
    result_path = os.path.join("result", args.net, '4GPU', 'kd', str(args.b), str(args.lr), settings.TIME_NOW)
    if args.local_rank == 0:
